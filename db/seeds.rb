...
File.open('app/assets/images/marvel-clip-art-free-free-clipart-images.jpeg') do |f|
...
File.open('app/assets/images/220-2205651_iron-man-iron-man-flying-png-transparent-png.png') do |f|
  iron_man.avatar = f
end
iron_man.save
...
File.open('app/assets/images/e7e1ba9cd159f4917d6befbf2d009bc1.jpg') do |f|
...
File.open('app/assets/images/3-38432_blackwidow-natasharomanoff-comic-marvelcomics-marvel-marvel-black-widow.png') do |f|
...
File.open('app/assets/images/13-137307_batman-comic-png-dc-comics-batman-new-52.png') do |f|
  bat_man.avatar = f
end
bat_man.save
...
File.open('app/assets/images/15-156846_superman-batman-drawing-superhero-image-cartoon-superman-hd.png') do |f|
  super_man.avatar = f
end
super_man.save
...
File.open('app/assets/images/c4eac7ec6c790db3347d03e769071e5a.png') do |f|
  aqua_man.avatar = f
end
aqua_man.save
...
File.open('app/assets/images/385-3855167_its-what-people-expect-wonder-woman-comic-png.png.jpeg') do |f|
...
File.open('app/assets/images/548546.jpg') do |f|
  magneto.avatar = f
end
magneto.save
...
File.open('app/assets/images/8a160a417aaf22de8322a6f6b0dc211d.jpg') do |f|
  thanos.avatar = f
end
thanos.save
...
File.open('app/assets/images/49-497245_red-skull-marvel-xp-red-skull-marvel-white.png.jpeg') do |f|
  red_skull.avatar = f
end
red_skull.save
...
File.open('app/assets/images/79-790191_mystique-marvel-xp-x-men-blue-body-paint.png.jpeg') do |f|
  mystique.avatar = f
end
mystique.save
...
File.open('app/assets/images/70-709521_slade-wilson-53-batman-arkham-origins-deathstroke-png.png.jpeg') do |f|
...
File.open('app/assets/images/248-2481852_joker-joker-dc-comics-png-transparent-png.png') do |f|
  joker.avatar = f
end
joker.save
...
File.open('app/assets/images/08LEXLUTHORBU11_CA_DCJLA_RED_04_1200x1200.jpg') do |f|
  lex_luthor.avatar = f
end
lex_luthor.save
...
File.open('app/assets/images/d5uy5fc-23df9b62-c6bb-490f-87d4-54334162cc25.jpg') do |f|
  poison_ivy.avatar = f
end
poison_ivy.save
